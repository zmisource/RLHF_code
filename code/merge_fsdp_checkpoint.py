...
fsdp_checkpoint_path = "/train/output_model/llama3-8b-sympo-default/checkpoint-3753" # <--- ‼️ 请修改为你的 checkpoint 路径
consolidated_model_path = "/train/output_model/consolidate_model/checkpoint-3753" # <--- ‼️ 你可以自定义保存路径
