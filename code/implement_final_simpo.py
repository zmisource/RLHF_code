...
class CustomSymPOTrainer(Trainer):
    ...
    def _get_log_probs(
        ...
        try:
            ...
            prompt_inputs = processor(
                ...
                padding=False,
                truncation=False, 
                add_special_tokens=False,  # <--- 必须 False
            ...
            for i, prompt_len in enumerate(prompt_lengths):
                ...
                response_start_idx = pad_len + prompt_len
                if response_start_idx < input_ids.shape[1]:
                    loss_mask[i, response_start_idx:] = 1.0
            ...
            shifted_mask = loss_mask[..., 1:] # mask 也要
            ...
            masked_log_probs = log_probs_per_token * shifted_mask
            total_log_probs = masked_log_probs.sum(dim=1)
            valid_response_lens = shifted_mask.sum(dim=1)
    ...
    def compute_loss(self, model, inputs, return_outputs=False, **kwargs):
        ...
        logs = {
            ...
            "ratio_chosen_mean": ratio_y1.mean().item(),
        }
