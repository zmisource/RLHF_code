...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="/train/output_model/llama3-8b-sympo-5e-5", help="Directory to save checkpoints and final model.")
    ...
    parser.add_argument("--save_steps", type=int, default=20, help="Save a checkpoint every N steps.")
