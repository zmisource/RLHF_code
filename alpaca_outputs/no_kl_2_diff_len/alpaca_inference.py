...
def parse_args():
    ...
    parser.add_argument("--model_path", type=str, default="/train/output_model/merged-llama3-8b-sympo-1e-6_0.1_no_kl_42_4096-checkpoint-500", help="要评估的合并后模型的路径")
    parser.add_argument("--model_display_name", type=str, default="Llama-3-8B-Instruct-sympo-1e-6_0.1_no_kl_42_4096-checkpoint-500", help="在排行榜中显示的模型名称")
