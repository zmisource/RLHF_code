...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="/train/output_model/llama3-8b-sympo-1e-6_0.5_seed_42_4096_padding_left", help="Directory to save checkpoints and final model.")
    ...
    parser.add_argument("--save_steps", type=int, default=700, help="Save a checkpoint every N steps.")
